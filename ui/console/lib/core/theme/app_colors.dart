...
/// Iron Orbit color palette adapted for the console back-office.
///
/// Mirrors the thesa admin shell palette so the operator surface
/// reads as part of the same product family. Each color exposes a
/// tonal scale from T0 (darkest) to T100 (lightest).
class AppColors {
  AppColors._();
