...
/// Material 3 theme for the console back-office. Mirrors the thesa
/// admin shell so operator surfaces feel like one product family.
class AppTheme {
  AppTheme._();
  ...
  static ThemeData _build(Brightness brightness) {
    ...
    final scheme = ColorScheme(
      ...
      surface: isLight ? AppColors.surface : AppColors.primarySwatch[900]!,
    ...
    return ThemeData(
      ...
      scaffoldBackgroundColor:
          isLight ? AppColors.background : AppColors.primarySwatch[900]!,
