...
final pricingTransportProvider = Provider<Transport>((ref) {
  final tokenProvider = ref.watch(authTokenProviderProvider);
  return createTransport(tokenProvider, baseUrl: _commerceUrl);
});

final pricingServiceClientProvider = Provider<CommerceServiceClient>((ref) {
  final transport = ref.watch(pricingTransportProvider);
